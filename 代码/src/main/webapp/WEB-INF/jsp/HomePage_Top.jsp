...
<body style="color: #e7e1cd">
  ...
  <nav class="navbar navbar-expand-md navbar-light fixed-top bg-light"><!--所有功能的导航栏-->
      <!--这个代码表示导航栏的品牌是一个链接，点击该链接将跳转到${pageContext.request.contextPath}/index.do这个地址，品牌文本显示为"高八度"-->
      <a class="navbar-brand" href="${pageContext.request.contextPath}/index.do">高八度</a><!--navbar-brand"是 Bootstrap 提供的类，用于定义导航栏中的品牌元素-->
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse"><!--除了“高八度”之外 的导航栏-->
          ...
          <ul class="navbar-nav mr-auto"><!--左边4个功能 的导航栏-->
              <li class="nav-item" id="exploringId"><!--这是一个列表项，具有类 "nav-item" 。"nav-item" 通常用于表示导航栏中的项，而 "exploringId" 可能是用于标识该列表项的唯一标识符-->
                  <a class="nav-link" href="#">发现音乐</a><!--在列表项中的链接元素。它有一个类名 "nav-link"，通常用于定义导航链接的样式。href="#" 表示链接的目标是当前页面，因为 "#" 通常用作空链接。文本内容是 "发现音乐"，它将显示为用户可单击的可点击文本-->
              </li>
              ...
              <li class="nav-item" id="Friends_ActivityId">
                  <a class="nav-link" href="#"  onclick="Friends_Activity_Page()">好友空间</a>
              </li>
          </ul>
  ...
  <script>
	$(function(){
        //在导航栏里点击“发现音乐”时触发explorin(trending rec)
